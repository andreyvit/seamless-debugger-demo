...
public class HelloInterpreterDialog extends AddScriptInterpreterDialog {

	public HelloInterpreterDialog(IAddInterpreterDialogRequestor requestor,
	...
	protected AbstractInterpreterLibraryBlock createLibraryBlock(
		...
		return new HelloInterpreterLibraryBlock(dialog);
	}
}
