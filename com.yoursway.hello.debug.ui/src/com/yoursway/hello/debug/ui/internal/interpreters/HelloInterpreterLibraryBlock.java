 ...
 */
public class HelloInterpreterLibraryBlock extends
		AbstractInterpreterLibraryBlock {
	
	protected static final String DIALOG_SETTINGS_PREFIX = "HelloInterpreterLibraryBlock"; //$NON-NLS-1$

	public HelloInterpreterLibraryBlock(AddScriptInterpreterDialog d) {
		super(d);
	}
	...
	protected IDialogSettings getDialogSettions() {
		return HelloDebugUIPlugin.getDefault().getDialogSettings();
	}
