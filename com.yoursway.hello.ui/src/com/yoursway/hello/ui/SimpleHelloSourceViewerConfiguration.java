...
public class SimpleHelloSourceViewerConfiguration extends HelloSourceViewerConfiguration {
    
    private final boolean fConfigureFormatter;
    
    public SimpleHelloSourceViewerConfiguration(IColorManager colorManager, IPreferenceStore preferenceStore,
